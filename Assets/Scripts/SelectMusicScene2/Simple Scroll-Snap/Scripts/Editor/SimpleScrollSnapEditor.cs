...
namespace DanielLochner.Assets.SimpleScrollSnap
{
    ...
    public class SimpleScrollSnapEditor : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            onBeginSelecting = serializedObject.FindProperty("onBeginSelecting");
        ...
        private void EventHandlers()
        {
            ...
            if (showEvents)
            {
                ...
                EditorGUILayout.PropertyField(onBeginSelecting, new GUIContent("On Panel Changed"));
